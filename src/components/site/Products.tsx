...
const items = [
  ...
  {
    img: tech,
    title: "Lentes de Tecnologia",
    desc: "Filtro de luz azul, transitions e antirreflexo premium.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="max-w-2xl reveal">
          ...
          <h2 className="mt-3 font-serif text-4xl md:text-5xl text-primary">
            Coleções selecionadas a dedo
          </h2>
          <p className="mt-4 text-muted-foreground">
            Peças escolhidas por especialistas, das marcas mais desejadas do mundo.
          </p>
        </div>
          ...
          {items.map((it, i) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-secondary shadow-card aspect-4/5">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-primary/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
